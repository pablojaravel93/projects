...
signData = {
    ...
    'menuItemId': 'report::summarypublisher::index', # one of menuItemId
...
#Report URL
url = "https://cp-inst528-client.phonexa.com/export/api?menuItemId=report::summarypublisher::index&apiId=F7524164CD1D4380A5993362E5F583AC&signature="+signature+"&component=lms"
print(url)
