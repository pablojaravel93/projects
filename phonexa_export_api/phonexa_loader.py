...
def get_report_url():
    signData = {
        ...
        'menuItemId': 'report::summarypublisherbydate::index', # one of menuItemId
    ...
    url = "https://cp-inst528-client.phonexa.com/export/api?menuItemId=report::summarypublisherbydate::index&apiId=F7524164CD1D4380A5993362E5F583AC&signature="+signature+"&component=lms"
    return url
...
def upload_to_gcs(resp) -> str:
    ...
    filename = f"export_{now.strftime('%Y%m%dT%H%M%S')}.csv"
