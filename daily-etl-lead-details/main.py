...
GCS_PREFIX = ""           
BQ_DATASET = "staging"
BQ_TABLE = "stg_lead_details_yday"
BQ_LOCATION = "US"

def get_report_url():
    signData = {
        'date': datetime.now().strftime('%d.%m.%Y'), # Current Date in format d.m.Y
    ...
    date_parameter = yesterday_str + " 00:00:00 - " + yesterday_str + " 23:59:59"
